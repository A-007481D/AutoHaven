        ...
        <aside class="w-64 bg-white shadow-lg">
            ...
            <nav class="mt-6 px-6">
                <div class="space-y-4">
                    ...
                    <a href="categories.php" class="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition-colors">
                        <span class="mr-3">📁</span>
                        Categories
                    </a>
                    <a href="users.php" class="flex items-center px-4 py-2 bg-blue-50 text-blue-600 rounded-lg transition-colors">
                        <span class="mr-3">👥</span>
                        Manage Users
                    </a>
